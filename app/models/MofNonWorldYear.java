...
@Entity
@View(name = "\"MOF_NWLD_YEAR\"")
public class MofNonWorldYear extends BaseModel {
    ...
    public static List<MofNonWorldYear> findListByHsCodeAndAreaId(String hsCode6, String areaId) {
        ExpressionList<MofNonWorldYear> expressionList = getEbeanServer().createQuery(MofNonWorldYear.class).where();
