...
@Entity
@View(name = "\"UN_NWLD_MONTH\"")
public class UnNonWorldMonth extends BaseModel {
    ...
    public static List<UnNonWorldMonth> findListByHsCodeAndReporterIso3AndAreaId(String hsCode6, String reporterIso3, String areaId) {
        ExpressionList<UnNonWorldMonth> expressionList = getEbeanServer().createQuery(UnNonWorldMonth.class).where();
