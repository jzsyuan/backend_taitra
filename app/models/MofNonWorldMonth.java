...
@Entity
@View(name = "\"MOF_NWLD_MONTH\"")
public class MofNonWorldMonth extends BaseModel {
    ...
    public static List<MofNonWorldMonth> findListByHsCodeAndAreaId(String hsCode6, String areaId) {
        ExpressionList<MofNonWorldMonth> expressionList = getEbeanServer().createQuery(MofNonWorldMonth.class).where();
