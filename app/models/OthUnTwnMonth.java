...
@Entity
@View(name = "\"OTH_UN_TWN_MONTH\"")
public class OthUnTwnMonth extends BaseModel {
    ...
    public static List<OthUnTwnMonth> findListByHsCodeAndReporterIso3AndAreaId(String hsCode6, String reporterIso3, String areaId) {
        ExpressionList<OthUnTwnMonth> expressionList = getEbeanServer().createQuery(OthUnTwnMonth.class).where();
