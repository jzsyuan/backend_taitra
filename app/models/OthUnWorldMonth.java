...
@Entity
@View(name = "\"OTH_UN_WLD_MONTH\"")
public class OthUnWorldMonth extends BaseModel {
    ...
    public static List<OthUnWorldMonth> findListByHsCodeAndReporterIso3AndAreaId(String hsCode6, String reporterIso3, String areaId) {
        ExpressionList<OthUnWorldMonth> expressionList = getEbeanServer().createQuery(OthUnWorldMonth.class).where();
