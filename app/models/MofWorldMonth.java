...
@Entity
@View(name = "\"MOF_WLD_MONTH\"")
public class MofWorldMonth extends BaseModel {
    @Column(name = "\"TXN_YTM\"")
    ...
    public static List<MofWorldMonth> findListByHsCode(String hsCode6) {
        ExpressionList<MofWorldMonth> expressionList = getEbeanServer().createQuery(MofWorldMonth.class).where();
