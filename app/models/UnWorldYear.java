...
@Entity
@View(name = "\"UN_WLD_YEAR\"")
public class UnWorldYear extends BaseModel {
    ...
    public static List<UnWorldYear> findListByHsCodeAndReporterIso3(String hsCode6, String reporterIso3) {
        ExpressionList<UnWorldYear> expressionList = getEbeanServer().createQuery(UnWorldYear.class).where();
