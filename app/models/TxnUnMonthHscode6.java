...
@Entity
@Table(name = "\"TXN_UN_MONTH_HSCODE6\"")
public class TxnUnMonthHscode6 extends BaseModel {
    ...
    public static List<TxnUnMonthHscode6> findByHsCode4AndReporterIso3AndPartnerIso3(String hsCode4, String reporterIso3, List<String> partnerIso3List) {
        ExpressionList<TxnUnMonthHscode6> expressionList = getEbeanServer().createQuery(TxnUnMonthHscode6.class).where();
