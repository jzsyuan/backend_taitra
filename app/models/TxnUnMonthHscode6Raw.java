...
@Entity
@Sql
public class TxnUnMonthHscode6Raw extends Model {
    ...
    public static List<TxnUnMonthHscode6Raw> findByHscode6AndCNTYAndArea(String hscode, String cnty, String area) {
        String sql = "select\n" +
                " a.\"TXN_YTM\", a.\"REPORTER_ISO3\", a.\"PARTNER_ISO3\", a.\"HSCODE_6\", a.\"TRADE_WEIGHT\", a.\"TRADE_AMT\", a.\"TRADE_AMT_DIFFERENCE\", a.\"TRADE_AMT_GROWRATE\", a.\"TRADE_AMT_PERCENT\", a.\"WEIGHT_DIFFERENCE\", a.\"WEIGHT_GROWRATE\", a.\"WEIGHT_PERCENT\",\n" +
                ...
                " a.\"TRADE_AMT_AREARANK\", a.\"TRADE_AMT_DIFFERENCE_AREARANK\", a.\"TRADE_AMT_GROWRATE_AREARANK\", a.\"TRADE_AMT_PERCENT_AREARANK\", a.\"WEIGHT_AREARANK\", a.\"WEIGHT_DIFFERENCE_AREARANK\", a.\"WEIGHT_GROWRATE_AREARANK\", a.\"WEIGHT_PERCENT_AREARANK\",\n" +
                " b.\"COUNTRY_COMM_ZH\", b.\"COUNTRY_COMM_EN\", b.\"AREA_ID\", b.\"AREA_NM\",\n" +
                " c.\"TARIFF\"\n" +
                " from public.\"TXN_UN_MONTH_HSCODE6\" a\n" +
                " LEFT JOIN \"REF_COUNTRY_AREA\" b ON a.\"REPORTER_ISO3\" = b.\"ISO3\"\n" +
                " LEFT JOIN public.\"TXN_UN_YEAR_HSCODE6\" c ON SUBSTRING(a.\"TXN_YTM\" FROM 1 FOR 4) = c.\"TXN_YEAR\" and a.\"HSCODE_6\" = c.\"HSCODE_6\" and a.\"REPORTER_ISO3\" = c.\"REPORTER_ISO3\" and a.\"PARTNER_ISO3\" = c.\"PARTNER_ISO3\"\n" +
                " where a.\"HSCODE_6\" = '" + hscode + "' and a.\"REPORTER_ISO3\" = '" + cnty + "'";
        if (area != null && !area.isEmpty()) {
            sql += " and b.\"AREA_ID\" = '" + area + "';";
        }
        RawSql rawSql = RawSqlBuilder.unparsed(sql)
                .columnMapping("a.\"TXN_YTM\"", "txnYtm")
                ...
                .columnMapping("a.\"TRADE_AMT_AREARANK\"", "tradeAmtRankHscode")
                ...
                .columnMapping("a.\"WEIGHT_GROWRATE_AREARANKE\"", "weightGrowrateArearank")
                ...
                .columnMapping("c.\"TARIFF\"", "tariff")
                .create();

        Query<TxnUnMonthHscode6Raw> query = DB.find(TxnUnMonthHscode6Raw.class);
