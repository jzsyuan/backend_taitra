...
@Entity
@Table(name = "\"TXN_UN_YEAR_HSCODE4\"")
public class TxnUnYearHscode4 extends BaseModel {
    ...
    public static List<TxnUnYearHscode4> findByHsCode4AndReporterIso3AndPartnerIso3(String hsCode4, String reporterIso3, String partnerIso3) {
        ExpressionList<TxnUnYearHscode4> expressionList = getEbeanServer().createQuery(TxnUnYearHscode4.class).where();
