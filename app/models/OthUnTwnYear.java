...
@Entity
@View(name = "\"OTH_UN_TWN_YEAR\"")
public class OthUnTwnYear extends BaseModel {
    ...
    public static List<OthUnTwnYear> findListByHsCodeAndReporterIso3AndAreaId(String hsCode6, String reporterIso3, String areaId) {
        ExpressionList<OthUnTwnYear> expressionList = getEbeanServer().createQuery(OthUnTwnYear.class).where();
