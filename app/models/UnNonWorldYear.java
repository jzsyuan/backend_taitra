...
@Entity
@View(name = "\"UN_NWLD_YEAR\"")
public class UnNonWorldYear extends BaseModel {
    ...
    public static List<UnNonWorldYear> findListByHsCodeAndReporterIso3AndAreaId(String hsCode6, String reporterIso3, String areaId) {
        ExpressionList<UnNonWorldYear> expressionList = getEbeanServer().createQuery(UnNonWorldYear.class).where();
