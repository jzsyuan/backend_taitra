...
@Entity
@Table(name = "\"TXN_MOF_MONTH_HSCODE4\"")
public class TnxMofMonthHscode4 extends BaseModel{
    ...
    public static List<TnxMofMonthHscode4> findByHsCode4AndPartnerIso3(String hsCode4, String partnerIso3) {
        ExpressionList<TnxMofMonthHscode4> expressionList = getEbeanServer().createQuery(TnxMofMonthHscode4.class).where();
