...
@Entity
@Sql
public class TxnMofMonthHscode6Raw extends Model {
    ...
    public static List<TxnMofMonthHscode6Raw> findByHscodeAndCNTY(String hscode, String cnty) {
        /*
        String sql = "select a.\"TXN_YTM\", a.\"HSCODE_6\",\n" +
                ...
                "    b.\"TARIFF\"\n" +
                "    from public.\"TXN_MOF_MONTH_HSCODE6\" a\n" +
                "    LEFT JOIN public.\"TXN_UN_YEAR_HSCODE6\" b ON SUBSTRING(a.\"TXN_YTM\" FROM 1 FOR 4) = b.\"TXN_YEAR\" and a.\"HSCODE_6\" = b.\"HSCODE_6\" and a.\"PARTNER_ISO3\" = b.\"PARTNER_ISO3\"" +
                "    where a.\"HSCODE_4\" = '" + hscode + "' and a.\"PARTNER_ISO3\" = '" + cnty + "' and b.\"REPORTER_ISO3\" = 'TWN';";
        */
        String sql = "select a.\"HSCODE_4\", a.\"HSCODE_6\", a.\"PARTNER_ISO3\", a.\"TXN_YTM\",\n" +
                ...
                "b.\"TARIFF\" \n" +
                "from(select \"HSCODE_4\",\"HSCODE_6\",\"PARTNER_ISO3\",\"TXN_YTM\" ,\n" +
                ...
                "from \"TXN_MOF_MONTH_HSCODE6\" ) as a\n" +
                "left join (select \"TXN_YEAR\",\"HSCODE_6\",\"REPORTER_ISO3\",\"TARIFF\"\n" +
                "from \"TXN_UN_YEAR_HSCODE6\"\n" +
                "where \"PARTNER_ISO3\"='TWN') as b\n" +
                "on a.\"PARTNER_ISO3\" = b.\"REPORTER_ISO3\" and substring(a.\"TXN_YTM\",1,4)  = b.\"TXN_YEAR\" and a.\"HSCODE_6\" = b.\"HSCODE_6\"\n" +
...
"TRADE_AMT_RANK_HSCODE" ,"TRADE_AMT_DIFFERENCE_RANK_HSCODE" ,"TRADE_AMT_GROWRATE_RANK_HSCODE","TRADE_AMT_PERCENT_RANK_HSCODE"
"WEIGHT_RANK_HSCODE" ,"WEIGHT_DIFFERENCE_RANK_HSCODE" ,"WEIGHT_GROWRATE_RANK_HSCODE","WEIGHT_PERCENT_RANK_HSCODE"
from "TXN_MOF_MONTH_HSCODE6" ) as t1
left join (select "TXN_YEAR","HSCODE_6","REPORTER_ISO3","TARIFF"
from "TXN_UN_YEAR_HSCODE6"
where "PARTNER_ISO3"='TWN') as a1
on t1."PARTNER_ISO3" = a1."REPORTER_ISO3" and substring(t1."TXN_YTM",1,4)  = a1."TXN_YEAR" and t1."HSCODE_6" = a1."HSCODE_6"
where "PARTNER_ISO3" ='" + cnty + "' and "HSCODE_4"='" + hscode + "';
         */
        ...
        Query<TxnMofMonthHscode6Raw> query = DB.find(TxnMofMonthHscode6Raw.class);
